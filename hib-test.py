...
#      REVISION:  Thu Mar 23 13:05:37 EDT 2017
#===============================================================================
...
###pset.addPrimitive(op.and_, [float, float], float)
###pset.addPrimitive(op.or_, [float, float], float)
...
###pset.addPrimitive(op.not_, [float], float)
...
#x1, result = evals.reclass(x, result)
